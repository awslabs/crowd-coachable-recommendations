...
def VAE_training(item_df,
    ...
    def tokenize_function(examples):
        result = tokenizer(examples["TITLE"],truncation=True,padding='max_length',max_length=max_length)
        return result
    ...
    tokenized_datasets = ds.map(tokenize_function, batched=True, remove_columns=["TITLE"])
